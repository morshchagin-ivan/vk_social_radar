...
[Backlog U01–U17](05_UPGRADE_BACKLOG.md) остаётся исходным приоритетным списком. P2: U14 scheduling/durable jobs, U15 local export/restore, U16 graph/scores, U17 search/retrieval evolution. U02/U03/U05/U09 закрыты в заявленном scope; U04 — следующий рекомендуемый implementation increment, без автоматического начала. RAG NO_RAG/PLANNED, Ollama/fallback NO. [Baseline report](BASELINE_UPGRADE_REPORT.md) остаётся историческим; новые результаты находятся в отдельных build reports.
