...
| Reproducibility: runner collection / known revision | U07: 191 discoverable tests, 7 gates, 12 fitness invariants PASS; initial local run 8.565s | retain one local/CI command; verify remote Actions separately | Python 3.13.2/Node 22.14.0 on Windows, synthetic fixtures, measured runner summary; [reference](QUALITY_GATE_REFERENCE.md) | U07 local IMPLEMENTED; remote unverified |
